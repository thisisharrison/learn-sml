...
use "section2/assignment/hw2.sml";

val test1 = all_except_option ("string", ["string"]) = SOME [];
val test1a = all_except_option("world", ["hello", "world", "how", "are", "you"]) = SOME ["hello","how","are","you"];
val test1b = all_except_option("Fred", ["Freddie", "Fred", "F"]) = SOME ["Freddie","F"];
